...
import { GriDisclosureForm } from "@/components/gri/gri-disclosure-form";
import { griApi, ApiError } from "@/lib/api";
import type { GriReport, GriMetrics } from "@/lib/types";
      ...
      <main className="mx-auto max-w-4xl px-6 py-10">
        ...
        {!loading && !loadError && (report == null || materialityIncomplete) && (
          <Card className="mt-6 p-6">
            ...
            <Link href={`/facilities/${params.id}/gri/${encodeURIComponent(period)}/materiality`} className="mt-5 inline-block">
              <Button>Go to materiality assessment</Button>
            </Link>
          </Card>
        )}
