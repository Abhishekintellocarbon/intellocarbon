...
import { reportingPeriodSchema } from "@/lib/validations/issb";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 py-10">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold">Add ISSB IFRS S1 & S2 disclosure</h1>
            <p className="text-sm text-muted-foreground">
              Disclose Governance, Strategy, Risk Management, and Metrics & Targets for a financial year.
            </p>
          </div>
        </div>
        ...
        {period === null ? (
          ...
          <IssbS1S2Form facilityId={params.id} reportingPeriod={period} />
        )}
      </main>
    </div>
  );
...
export default function NewIssbReportPage() {
  return (
    <ProtectedRoute>
      <NewIssbReportContent />
    </ProtectedRoute>
  );
}
