...
export const CALC_RESULT_FIELDS: { key: keyof EmissionCalculationResult; label: string }[] = [
  ...
  { key: "directCombustionCo2eAr2Bur3", label: "Direct Combustion CO2e (AR2/BUR3)" },
  ...
  { key: "directPfcCo2eAr2Bur3", label: "Direct PFC CO2e (AR2/BUR3)" },
  { key: "directN2oProcessCo2eAr5", label: "Direct N2O Process CO2e (AR5)" },
  { key: "directN2oProcessCo2eAr2Bur3", label: "Direct N2O Process CO2e (AR2/BUR3)" },
  ...
  { key: "totalDirectCo2eAr2Bur3", label: "Total Direct CO2e (AR2/BUR3)" },
  { key: "totalEmissionsCbamAr5", label: "Total Emissions — CBAM (AR5)" },
  { key: "totalEmissionsCctsAr2Bur3", label: "Total Emissions — CCTS (AR2/BUR3)" },
