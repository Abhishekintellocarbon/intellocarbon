...
/** Facilities under companies assigned to this verifier that have at least one submitted entry to review. */
export const listAssignedFacilities = async (verifierId: string) => {
